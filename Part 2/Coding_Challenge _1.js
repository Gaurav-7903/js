...
const avgCalculation = (a,b,c) => (a+b+c)/3;
...
checkWinner(avgCalculation(44,23,71), avgCalculation(65,54,49));
checkWinner(avgCalculation(85,54,41) , avgCalculation(23,34,27));
