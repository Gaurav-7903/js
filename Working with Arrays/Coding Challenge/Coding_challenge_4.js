...
Loop over the 'dogs' array containing dog objects, and for each dog, calculate the recommended food portion and add it to the object as a new property. Do not create a new array, simply loop over the array.
...
console.log("This is Sarah Dog",sarahDog);
console.log(`it eating too ${sarahDog.curFood > sarahDog.recommendedFood ? 'much' : 'less'}`); 
...
const dogsEatingOkay = dogs.some(dog => dog.curFood == dog.recommendedFood);
console.log("Dogs eating okay amount of food", dogsEatingOkay);

//6
const isAnyDogEatingOkay = dogs.some(dog => dog.curFood > (dog.recommendedFood * 0.9) && dog.curFood < (dog.recommendedFood * 1.1));
console.log("Is any dog eating okay amount of food?", isAnyDogEatingOkay);

//7
const dogsEatingOkayCopy = dogs.filter(dog => dog.curFood > (dog.recommendedFood * 0.9) && dog.curFood < (dog.recommendedFood * 1.1));
console.log(dogsEatingOkayCopy);
